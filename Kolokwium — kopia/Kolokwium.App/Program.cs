...
namespace Kolokwium.App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n\n\n Zadanie 2");
            school.Students.ForEach((student) => Console.WriteLine($"Hello, {student.FirstName}"));
            var people = new List<Person>();
            Console.WriteLine("\n\nTest AddRange");
            people.AddRange(school.Teachers);
            people.AddRange(school.Students);
            people.ForEach((student) => Console.WriteLine($"Hello, {student.FirstName}"));
        }
    }
}