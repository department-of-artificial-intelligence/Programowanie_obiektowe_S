namespace Lab_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            person2.Details(); Grade grade = new Grade("Bazy Danych", 5.0D, new DateTime(2011, 5, 1));
            ...
            Person handballPlayer = new HandballPlayer("Piotr", "Kos", new DateTime(1984, 9, 14), "striker", "FC Bayern", 8);
            footballPlayer.Details(); handballPlayer.Details(); ((Player)handballPlayer).ScoreGoal();
            // rzutowanie bezpośrednie (footballPlayer as Player).ScoreGoal(); // rzutowanie referencyjne footballPlayer.Details(); handballPlayer.Details(); 
