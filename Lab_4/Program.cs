class Person
{
    ...
    public override string ToString()
    {
        ...
        return $"Person | FirstName {FirstName}, LastName {LastName}, DateTime {DateOfBirth}";
...
class Lecturer : Person
{
    ...
    public override string ToString()
    {
        ...
        return $"Lecturer | FirstName {FirstName}, LastName {LastName}, DateTime {DateOfBirth}, AcademicTitle {AcademicTitle}," +
            $"Position {Position}";
...
class Subject
{
    ...
    public override string ToString()
    {
        ...
        return $"Subject | Name {Name}, Specialization {Specialization}, Semester {Semester}, HourCount, {HoursCount}";
...
class Student : Person
{
    ...
    public override string ToString()
    {
        ...
        return $"Student | FirstName {FirstName}, LastName {LastName}, DateOfBirth {DateOfBirth}, Specializtion {Specialization}," +
...
class Department
{
    ...
    public override string ToString()
    {
        ...
        return $"Department | Name {Name}, Person {Dean}, OrganizationUnits {OrganizationUnits}," +
            $"Subject {Subjects}, Students {Students}";
