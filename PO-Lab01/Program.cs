...
class Program
{
    static void Main()
    {
        ...
        person1.AddCarRegistrationNumber("WE12345");
        person1.AddCarRegistrationNumber("SK82503");
        person1.Details();
        ...
        person2.LastName = "Domański";
        person2.Address = "ul. Garażowa 5";
        person2.AddCarRegistrationNumber("XX00000");
        person2.Details();
        Console.WriteLine("\r\n=========================================\r\n");
    }
}