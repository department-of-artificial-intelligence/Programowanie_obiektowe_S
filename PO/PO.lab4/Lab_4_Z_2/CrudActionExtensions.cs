...
namespace Lab_4_Przygotowanie
{
    internal static class CrudActionExtensions
    {
        ...
        public static void ForeEach<TObjectType>(this IList<TObjectType> list, Action<TObjectType> action)
        {
        ...
        public static IContainer AddRange<TObjectType>(this IContainer container, IList<TObjectType> list)
        {
            if (container != null)
            {
                var cont = container.Set<TObjectType>();
