       ...
       public static void Main(string[] args)
            {
                ...
                Parking<Car> carParking = new Parking<Car>("Częstochowa Armii krajowej 22", 
                    new List<Car>() {truck1,truck2,regularCar1}, new List<Client>() {client1,client2 as Client,client3 as Client}, new List<Employee>() { employee as Employee });
