using Kolokwium.BLL;
    ...
    TCar truck1 = new Truck ("Mercedes", "x21,", "SC 12345", 10);
    Console.WriteLine (truck1.ToString ());
    truck1.Display ();
    TCar truck2 = new Truck ("Volvo", "v40,", "SC 54321", 15);
    TCar regularCar1 = new RegularCar ("Audi", "A4", "WW 12345", 5);
    Console.WriteLine (regularCar1.ToString ());
    regularCar1.Display ();
    TCar regularCar2 = new RegularCar ("Citroen", "C3", "WA 12312", 3);
    ...
    Parking<TCar> carParking = new Parking<TCar> ("Częstochowa Armii krajowej 22", new List<TCar> () {truck1,truck2,regularCar1}, new List<Client> () {client1,client2 as Client,client3 as Client}, new List<Employee> () { employee as Employee });
