...
using Przygotowanie.BLL;
    class Program
    {
        ...
        Subject sub1 = school.CreateSubject("Programowanie Obiektowe",
            "Przedmiot opisujący programowanie obiektowe w języku c#");
        Subject sub2 = school.CreateSubject("Bazy danych",
            "Przedmiot opisujący bazy danych oraz język SQL");
        ...
        Lesson lesson2 = school.CreateLesson(classRoom1, sub1, "Czwartek", new TimeSpan(12, 0, 0), new TimeSpan(14, 0, 0), teacher2);
        teacher1.AddLesson(lesson1);
        teacher2.AddLesson(lesson2);
        Student student1 = school.CreateStudent("Jacek", "Kowal", 5, 1, 123);
        Student student2 = school.CreateStudent("Tomasz", "Nowak", 5, 1, 123);
        Student student3 = school.CreateStudent("Jerzy", "Bednarski", 5, 1, 123);
        Student student4 = school.CreateStudent("Maciej", "Kowalski", 5, 1, 123);
        school.AddStudentToLesson(lesson1, student1);
        school.AddStudentToLesson(lesson1, student3);
